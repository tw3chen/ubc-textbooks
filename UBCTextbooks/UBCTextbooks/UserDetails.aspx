<%@ Page Language="C#" MasterPageFile="~/SiteTemplate.Master" AutoEventWireup="true" CodeBehind="UserDetails.aspx.cs" Inherits="UBCTextbooks.UserDetails" %>
<%@ MasterType VirtualPath="~/SiteTemplate.Master" %>
<%@ Import Namespace="System.Data" %>
<%@ Import Namespace="System.Globalization" %>
<asp:Content id="userdetails" ContentPlaceHolderID="Content" runat="server">
    <div>
        <h1><asp:Literal id="lt_userdetails" Text="" runat="server" /></h1>
        <p><asp:Literal id="lt_userdisplay" Text="" runat="server" />
        <br /><asp:Literal ID="lt_useremail" Text="" runat="server" /></p>
        ...
        <div id='div_hidden'>
            <asp:Literal id="lt_huserid" Text="" runat="server" />
        </div>
    </div>
