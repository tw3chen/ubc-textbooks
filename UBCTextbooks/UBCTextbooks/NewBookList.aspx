<%@ Page Language="C#" MasterPageFile="~/SiteTemplate.Master" AutoEventWireup="true" CodeBehind="NewBookList.aspx.cs" Inherits="UBCTextbooks.NewBookList" %>
<%@ MasterType VirtualPath="~/SiteTemplate.Master" %>
<asp:Content id="newbooklist" ContentPlaceHolderID="Content" runat="server">
    <div id="div_newbooklist">
        <h1><asp:Literal id="lt_newbooklist" Text="" runat="server" /></h1>
        <p><asp:Literal id="lt_newbooklist_description" Text="" runat="server" /></p>
        <table id="tb_selldetails"><!--9780132126311-->
            <tr>
                <td class="label"><asp:Literal id="lt_coursecode" Text="" runat="server" /></td>
                <td><asp:TextBox style="background-color:#F0F0F0;" Enabled="false" id="txt_coursecode" CssClass="textbox" runat="server" />
                <asp:RequiredFieldValidator ID="req_courescode" runat="server" ErrorMessage="<%$ Resources: String, msg_requiredfield %>" ControlToValidate="txt_coursecode" Display="Dynamic" /></td>
            </tr>
            <tr>
                <td class="label"><asp:Literal id="lt_isbn" Text="" runat="server" /></td>
                <td><asp:TextBox style="background-color:#F0F0F0;" Enabled="false" id="txt_isbn" CssClass="textbox" runat="server" />
            ...
            <tr>
                ...
                <td><asp:TextBox id="txt_title" CssClass="textbox" runat="server" />
                <asp:RequiredFieldValidator ID="req_title" runat="server" ErrorMessage="<%$ Resources: String, msg_requiredfield %>" ControlToValidate="txt_title" Display="Dynamic" /></td>
            </tr>
            <tr>
                <td class="label"><asp:Literal id="lt_author" Text="" runat="server" /></td>
                <td><asp:TextBox id="txt_author" CssClass="textbox" runat="server" /></td>
            </tr>
            <tr>
                <td></td>
                <td><asp:Literal id="lt_author_description" Text="" runat="server" /></td>
            </tr>
            <tr>
                <td class="label"><asp:Literal id="lt_edition" Text="" runat="server" /></td>
                <td><asp:TextBox id="txt_edition" CssClass="textbox" runat="server" /></td>
            </tr>
            <tr>
